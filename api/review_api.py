...
review_model = ns.model('Review', {
    ...
    'rating': fields.Integer(required=True, description='Rating given to the place (1-5)'),
    'comment': fields.String(required=False, description='Optional comment about the place'),
